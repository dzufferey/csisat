 ...
 * TODO this is the part where there is different strategies -> McMillan, Pudlack, anti-McMillan, other
 *)
...
let interpolate_with_proof a b = List.hd (interpolate_with_one_proof [a;b])
